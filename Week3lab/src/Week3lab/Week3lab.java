...
public class Week3lab {
	...
	public static void main(String[] args) {
		...
		//		c. How are they different?
			// Method 14 doesnt print anything where as method 13 does.
		...
		System.out.println(isPalindrome("is not"));
	...
	// Method 15:
	public static boolean isStringLonger(String string, int number) {
